...
public class ConcurrentPuzzleSolver<P,M> {
	...
	private final ConcurrentMap<P, Boolean> seen; // 保存之前搜索过的位置，用于防止无限循环
	// 使用闭锁确保解答最多只会被设置一次
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ConcurrentPuzzleSolver<Point, Move> solver = new ConcurrentPuzzleSolver<Point, Move>(new PointPuzzle(50));
